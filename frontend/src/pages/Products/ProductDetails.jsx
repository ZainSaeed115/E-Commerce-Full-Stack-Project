...
const ProductDetails = () => {
    ...
    const {data:product,isLoading,isError,error,refetch}=useGetProducDetailsQuery(productId)
    const [createProductReview,{isLoading:loadingProductReview}]=useCreateReviewsMutation()
  ...
  return (
    <div>
      <Link 
            to='/home' 
            className='flex items-center text-white ml-[10rem] font-semibold hover:underline cursor-pointer'
        >
            <FaArrowLeft className="mr-2" /> {/* Add margin to the right */}
            Go Back
        </Link>
