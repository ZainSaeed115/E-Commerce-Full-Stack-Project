...
const Shop = () => {
  ...
  const handlePriceChange=(e)=>{
    //update the price filter when user types the input field
    ...
    <div className="container mx-auto">
         <div className="flex md:flex-row">
            <div className="bg-[#151515] p-3 mt-2 mb-2">
              <h2 className=" text-center py-2 bg-black rounded-full mb-2 text-white">Filter By Categories</h2>
              ...
              <h2 className=" text-center py-2 bg-black rounded-full mb-2 text-white">
                ...
                <div className="p-5 w-[15rem]">
                  <input
                   ...
                   className="bg-gray-800 text-white border rounded w-full"
                  />
                </div>

                <div className="p-5 pt-0">
                  <button className="w-full border my-4 text-white
                   bg-pink-500 hover:bg-pink-600" onClick={()=>window.location.reload()}>Reset</button>
                </div>
            </div>
